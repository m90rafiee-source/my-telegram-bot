...
async def handle_reply(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if user.id == ADMIN_ID and "reply_to" in context.user_data:
        ...
        keyboard = InlineKeyboardMarkup([[InlineKeyboardButton(" پاسخ به ممد", callback_data="reply_admin")]])
    ...
    keyboard = InlineKeyboardMarkup([[InlineKeyboardButton(" پاسخ", callback_data=f"user_{user.id}")]])
    ...
    user_keyboard = InlineKeyboardMarkup([[InlineKeyboardButton(" پاسخ به ممد", callback_data="reply_admin")]])
